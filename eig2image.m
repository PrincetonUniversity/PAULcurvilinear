function [Lambda1,Lambda2,I1x,I1y,I2x,I2y]=eig2image(Dxx,Dxy,Dyy)
% Function is written by Marc Schrijver and Dirk-Jan Kroon
...
mu1 = 0.5*(Dxx + Dyy + tmp); % using 2nd order formula
mu2 = 0.5*(Dxx + Dyy - tmp);
...
I1x=v1x; I1x(check)=v2x(check);
I1y=v1y; I1y(check)=v2y(check);

I2x=v2x; I2x(check)=v1x(check);
I2y=v2y; I2y(check)=v1y(check);