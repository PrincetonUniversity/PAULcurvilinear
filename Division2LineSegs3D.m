...
% added 0611: get rid of heavily occupied subims [to save memory and time]
...
% IM_smoothed_bw_skel_cln=cellfun(@(x) bwmorph3(x,'clean'),IM_smoothed_bw_skel,'UniformOutput',false);
...
% m=10
% image3(FeatureEnhancedIM,0.5,0.5,0.5,1,1,'g',0.1); hold on
% view(2);axis image
% plot([24 24]+0.5,[0 64]+0.5,'m--');plot([56 56]+0.5,[0 64]+0.5,'m--');
% plot([0 64]+0.5,[24 24]+0.5,'m--');plot([0 64]+0.5,[56 56]+0.5,'m--');
% % plot([32 32],[0 64],'m--');
% % plot([0 64],[32 32],'m--');
% hl=plot3([AllPt1y{m}';AllPt2y{m}'],...
%     [AllPt1x{m}';AllPt2x{m}'],...
%     [AllPt1z{m}';AllPt2z{m}'],'Color','k','LineWidth',1);
