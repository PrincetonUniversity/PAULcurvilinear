...
% outputIM=CurLinFeatureEnhancement3D_ellip(contrastEnhancedIM, [0.1376 0.5229], [0.076 0.23], 0.5, 20, 1);
...
scale2PSFratio = [2 2 2];%1/sqrt(2); %1/sqrt(2) breaks into parts; 2 too thick and round
